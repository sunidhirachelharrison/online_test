    ...
    <div class="container-fluid mar">
        <div class="row">
            ...
            <div class="col-md-12">
				...
				echo '<tr><td><center>'.$c++.'</center></td><td><center>'."Quantitative Aptitude".'</center></td><td><center>'."35".'</center></td><td><center>'."30 minutes".'</center></td><td><center><b><a href="test.php" onclick="popitup(this.href);return false;" class="btn sub1" style="color:white;margin:0px;background:#ea5e0d;><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Start</b></span></a></b></center></td></tr>';
   ?>
                <script >
                    var a;
