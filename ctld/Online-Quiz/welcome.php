...
<!--
            <li <?php i//f(@$_GET['q']==2) echo'class="active"'; ?>> <a href="welcome.php?q=2"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>&nbsp;History</a></li>
        ...
        <div class="row">
            <div class="col-md-10">
                ...
                //{
                    ...
                    <tr><td><center><b>S.N.</b></center></td><td><center><b>Section</b></center></td><td><center><b>Total question</b></center></td><td><center><b>Total Marks</center></b></td><td><center><b>Action</b></center></td></tr>';
                    $c=1;

                        echo '<tr><td><center>'.$c++.'</center></td><td><center>'."Quantitative Aptitude".'</center></td><td><center>'."35".'</center></td><td><center>'."30".'</center></td><td><center><b><a href="quiz1.php" class="btn sub1" style="color:black;margin:0px;background:#1de9b6"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Start</b></span></a></b></center></td></tr>';
    
    
                        echo '<tr><td><center>'.$c++.'</center></td><td><center>'."Verbal Aptitude".'</center></td><td><center>'."15".'</center></td><td><center>'."10".'</center></td><td><center><b><a href="quiz2.php" class="btn sub1" style="color:black;margin:0px;background:#1de9b6;pointer-events:none"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Start</b></span></a></b></center></td></tr>';                    
