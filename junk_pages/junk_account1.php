...
//            saveResult(marked_value,qid);
            ...
            //**************************************************************
            counter=counter+1;
            if((counter==0)||(counter<5)) //replace 5 by 34 to fetch 35 questions
            {
                showUser(selected_qid[counter],counter);
                
            }
            else if(counter==5) //replace 5 by 34 to fetch 35 questions
            {
...
<?php
    ...
    ///{
        //$rad="demo";
        //echo $rad;
//        $q="INSERT into result(R_ID,R_Enrollment_No,R_Q_ID,R_Marked_Answer) VALUES (null,'".$_SESSION['U_Enrollment_No']."','".$row['Q_ID']."','".$_SESSION['x']."')";
//        
//        $q="INSERT into result(R_ID,R_Enrollment_No,R_Q_ID,R_Marked_Answer) VALUES (null,'TCA1805011','15','".$rad."')";
        
//        $q="INSERT into result (R_ID,R_Enrollment_No,R_Q_ID,R_Marked_Answer,R_Score_Quantitative,R_Score_Verbal,R_T_ID) VALUES (null,'TCA1805011','".$_SESSION['x']."','".$_SESSION['y']."',0,0,1)";
//        
//        $r=mysqli_query($con,$q);
//        if(!($r))
//        {
//            echo '<script>alert("Failed to save the results of current question!");</script>';
//        }
//        else
//        {
//            echo '<script>alert("Success to save the results of current question!");</script>';
//        }
//        
//    }
